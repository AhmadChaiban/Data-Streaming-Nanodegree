...
#
## Note that this is where the deserialization happens, it is done through defining the model types.
@dataclass
class ClickEvent(faust.Record):
    email: str
    timestamp: str   ## Notice that these
    uri: str         ## differ from the video lesson
    number: int
