...
## This is not done in usual applications, here the score data 
## is being fraudulently generated
...
## Use python exercise6.5.py worker to run
## Use kafka-console-consumer to view the stream