...
async def clickevent(clickevents):
    ...
    #
    async for clickevent in clickevents.filter(lambda x: x.number > 100 or x.number == 100):
        #
...
## run with python exercise6.4.py worker
## kafka-console-consumer to view stream
