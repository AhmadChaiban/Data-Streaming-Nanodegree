...
## Using the confluent AVRO built-in library is much easier than defining
## it manually. The Library takes care of fetching the schema automatically
## and sheperds it out of the avro format.
...
async def consume(topic_name):
    ...
    # warning: consumer must also use schema registry or else the data will be outputted
    # in binary format
    schema_registry = CachedSchemaRegistryClient(SCHEMA_REGISTRY_URL)
